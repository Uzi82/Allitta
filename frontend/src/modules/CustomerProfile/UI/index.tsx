...
import { Content, El, ElText, ElTitle, Image, ImageAndStatus, Info, Settings, Status, StatusImg, Verified } from "./styled"
import { getInfo, useJWT, infoList, SimpleBlur, useAppSelector, DeleteOrEditMerchantModal, useAppDispatch, openModal, DeleteMerchantModal, EditMerchantModal } from "../"
    ...
    return (
        <Content>
            ...
            <Info>
                ...
                <Settings onClick={() => dispatch(openModal({ type: "deleteOrEditMerchant" }))}>
                    Settings
                </Settings>
            </Info>
